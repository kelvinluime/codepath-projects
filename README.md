...
An app that allows users to browser current available movies using The Movie Database.
...
Photo browser app using Tumblr API.
...
A clone of the Yelp app with basic layout and functionalities using Yelp API.
...
A clone of the Twitter app with basic layout and functionalities using Twitter API.
...
A clone of the Tinder app with basic layout and functionalities.
...
A simple chat app that allows real-time chatting using Parse as a backend.
...
A simple app that allows users to use gestures to drag UI components.
...
A simple app that allows users to upload photo and tag it with a location.
